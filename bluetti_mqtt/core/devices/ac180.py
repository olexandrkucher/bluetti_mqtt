...
class AC180(BluettiDevice):
    def __init__(self, address: str, sn: str):
        ...
        # this is useful for investigating the available data
        # registers = {
        #     0:21, 100:67, 700:6, 720:49, 1100:51, 1200:90, 1300:31, 1400:48,
        #     1500:30, 2000:67, 2200:29, 3000:27, 6000:31, 6100:100, 6300:52, 7000:5
        # }
        # for k in registers:
